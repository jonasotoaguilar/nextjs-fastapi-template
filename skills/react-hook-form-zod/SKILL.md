...
metadata:
  scope: [root, ui]
  auto_invoke: "Implementing, refactoring, or validating UI forms that use React Hook Form, Zod schemas, or structured client-side validation logic."
---
...
z.string()
  .transform(parseInt)
  .refine((v) => v > 0); // Chain with refine
```
