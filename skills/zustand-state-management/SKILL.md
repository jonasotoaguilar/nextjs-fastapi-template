...
metadata:
  scope: [root, ui]
  auto_invoke: "Creating, refactoring, debugging, or integrating global client state in React applications using Zustand, including persistence, hydration, or TypeScript typing concerns."
---
