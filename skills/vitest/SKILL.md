...
metadata:
  ...
  scope: [root, ui]
  auto_invoke: "Creating, modifying, organizing, or running unit or component tests using Vitest, including mocking, coverage configuration, snapshots, or test environment setup."
---
