...
metadata:
  scope: [root, api]
  auto_invoke: "Creating, structuring, or refactoring FastAPI services, including async architecture, dependency injection, routing, validation, or production-ready backend patterns."
---
