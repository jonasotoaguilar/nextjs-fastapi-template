This template streamlines building APIs with [FastAPI](https://fastapi.tiangolo.com/) and dynamic frontends with [Next.js](https://nextjs.org/). It integrates the backend and frontend using [@hey-api/openapi-ts](https://github.com/hey-ai/openapi-ts) to generate a type-safe client, along with automated processes to keep the OpenAPI schema and client updated, ensuring a smooth and synchronized development workflow.
...
- [SQLAlchemy](https://www.sqlalchemy.org/): Powerful SQL toolkit and ORM for Python.
...
- Hot reload watchers:
  - Backend: [Watchdog](https://github.com/gorakhargosh/watchdog) for file change monitoring.
