				...
				<CardContent className="p-8 pt-4">
					<form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
						<div className="space-y-2">
							...
							{errors.email && (
								<p className="text-xs font-semibold text-red-500 ml-1 mt-1 flex items-center gap-1 animate-in slide-in-from-top-1">
						...
						{state?.message && (
							<div className="bg-green-50 dark:bg-green-900/10 py-3 px-4 rounded-xl border border-green-100 dark:border-green-900/30 animate-in fade-in">
